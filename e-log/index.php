...
$then=date("y:m:d");
echo strtotime($then."+ 2days");


$check = mysql_query("SELECT * FROM $table WHERE (close_out='Not Yet Analysed' or close_out='Forwarded')and report_no='18'" );
...
<body>
<div align='center'> <img src='images/logo.gif'>
<h1>Your success is our responsibility</h1></div>
<div class="homebody2">
        ...
        <form id="customer" name='Customer' action="customer.be.php" method="POST"  onsubmit="return validate_customer_form()" >
			 ...
			 >
			  ...
			  </label><div id="txtHint"><b> </b></div>
            </br>
	   		 <label for="complain">Complain: </label>
		    <textarea name="Complain" id="Complain" contenteditable="true" onfocus=' getCaret(Complain)'spellcheck="true" placeholder="Enter your complain "
			           maxlength="300" onfocus="setCaretPosition(this.id, 0)">
			 </textarea>
			 <?php include('capcha/ajax-fancy-captcha-php/example.html')?>
