...
$sql = "SELECT * FROM  $table1 WHERE close_out='Closed' AND Target_center='$Center' ORDER BY report_no LIMIT $start, $per_page";
$rsd = mysql_query($sql);
?>
	...
	<div class="formheader">Closed Reports Summery</div>
			 <table width="100%"  border="0" class="bodytable">
				<tr>
				 ...
				 <tr>
         <?php
		    //$result = mysql_query("SELECT * FROM  $table1 WHERE close_out='Closed' AND Target_center='$Center'");
