...
$sql = "SELECT * FROM  $table1  WHERE close_out='Forwarded'";
$rsd = mysql_query($sql);
...
<head>
   ...
   //Default Starting Page Results
	...
	$("#content").load("scm_report_sumery_forwarded_data.php?page=1", Hide_Load());
	...
	$("#pagination li").click(function(){
		...
		$("#content").load("scm_report_sumery_forwarded_data.php?page=" + pageNum, Hide_Load());
	});
