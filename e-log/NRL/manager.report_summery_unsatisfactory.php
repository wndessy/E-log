...
$sql = "SELECT * FROM  $table1 WHERE (scm_corective_coment!='No'|scm_preventive_coment!='No')
			AND Target_center='$Center'";
$rsd = mysql_query($sql);
...
<head>
   ...
   //Default Starting Page Results
	...
	$("#content").load("manager.report_summery_unsatisfactory_data.php?page=1", Hide_Load());
	...
	$("#pagination li").click(function(){
		...
		$("#content").load("manager.report_summery_unsatisfactory_data.php?page=" + pageNum, Hide_Load());
	});
...
<body>
	...
	<tr>
		<form method="post" action="../NRL/no_edit_view.php"><td>
