...
$sql = "SELECT * FROM  $table1  WHERE scm_submision_date!='Incomplete' ORDER BY report_no LIMIT $start, $per_page";
...
?>
 ...
 <table width="100%"  border="0" class="bodytable">
         ...
         <?php
		// $result = mysql_query("SELECT * FROM  $table1  WHERE scm_submision_date!='Incomplete' ");
