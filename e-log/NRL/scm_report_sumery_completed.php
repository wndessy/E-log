...
$sql = "SELECT * FROM  $table1  WHERE scm_submision_date!='Incomplete'";
$rsd = mysql_query($sql);
...
<head>
   ...
   //Default Starting Page Results
	...
	$("#content").load("scm_report_sumery_completed_data.php?page=1", Hide_Load());
	...
	$("#pagination li").click(function(){
		...
		$("#content").load("scm_report_sumery_completed_data.php?page=" + pageNum, Hide_Load());
	});
