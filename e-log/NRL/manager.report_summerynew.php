...
$sql = "SELECT * FROM  $table1 WHERE close_out='New' AND Target_center='$Center'";
$rsd = mysql_query($sql);
...
<head>
   ...
   //Default Starting Page Results
	...
	$("#content").load("manager.report_summerynew_data.php?page=1", Hide_Load());
	...
	$("#pagination li").click(function(){
		...
		$("#content").load("manager.report_summerynew_data.php?page=" + pageNum, Hide_Load());
	});
