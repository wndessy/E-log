...
$sql = "SELECT * FROM  $table1  WHERE close_out='Closed' ORDER BY report_no LIMIT $start, $per_page";
...
?>
	...
	<table width="100%"  border="0" class="bodytable">
		 ...
		 <tr>
			 ...
			 <td><p for="completion"> Close  Date</p>
			 <td><p for="scm">Center Manager</p>
		 </tr>
         <?php
		// $result = mysql_query("SELECT * FROM  $table1  WHERE close_out='Closed'");
