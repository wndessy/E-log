<?php
	class Captchaz
	{
		 ...
		 *
		 * The words were collected from random pages of the English Wikipedia <http://en.wikipedia.org/>
		 * The font was downloaded from WebpagePublicity.com <http://www.webpagepublicity.com/>
		 *
		 */
