...
$sql =" SELECT * FROM  $table WHERE close_out=CONCAT('department',' ','$department')AND center='$Center' and( root_cause='' OR preventive_action='' OR corrective_action='') ";
$rsd = mysql_query($sql);
...
<head>
   ...
   //Default Starting Page Results
	...
	$("#content").load("dm.report_summery_data.php?page=1", Hide_Load());
	...
	$("#pagination li").click(function(){
		...
		$("#content").load("dm.report_summery_data.php?page=" + pageNum, Hide_Load());
	});
...
<body>
	...
	<tr>
		<form method="post" action="dm.php"><td>
