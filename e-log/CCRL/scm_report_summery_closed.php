...
$sql = "SELECT * FROM  $table  WHERE close_out='Closed' && scm_submision_date='Incomplete'";
$rsd = mysql_query($sql);
...
<head>
   ...
   //Default Starting Page Results
	...
	$("#content").load("scm_report_summery_closed_data.php?page=1", Hide_Load());
	...
	$("#pagination li").click(function(){
		...
		$("#content").load("scm_report_summery_closed_data.php?page=" + pageNum, Hide_Load());
	});
...
<body>
	...
	<tr>
		<form method="post" action="scm_manager.php"><td>
